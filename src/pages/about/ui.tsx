...
export default function AboutPage() {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-tg-bg text-tg-text pb-tg-safe-bottom overflow-y-auto">
      ...
      <div className="flex-1 p-5 flex flex-col gap-4 max-w-md mx-auto w-full text-[14px] leading-relaxed text-tg-hint">
        <h3 className="text-lg font-bold text-tg-text">HabitFlow v1.0.0</h3>
        <p>
        ...
        <h4 className="font-bold text-tg-text mt-3">Features:</h4>
